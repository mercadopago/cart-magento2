...
class OrderCancelPlugin
{
    ...
    protected function salesOrderBeforeCancel()
    {
      ...
      $cancelAvailable = $this->_scopeConfig->getValue(\MercadoPago\Core\Helper\ConfigData::PATH_ORDER_CANCEL_AVAILABLE, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
